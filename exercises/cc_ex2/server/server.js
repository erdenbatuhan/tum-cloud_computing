...
app.get('/api', (_, res) => {
  ...
  res.json({
    ...
    endpoints: [
      ...
      {method: 'GET', path: '/api/exercise2', description: 'Send message for Exercise 2'}
    ]
  })
});
...
/*
 * Send message for Exercise 2
 */
app.get('/api/exercise2', (req, res) => {
  // Send the message as stated in the hints section.
  res.send("Application deployed using docker!");
});
